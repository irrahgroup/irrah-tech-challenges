...
O **BCB** é um sistema para envio de mensagens (SMS/WhatsApp) com:
- Cadastro de clientes (PF/PJ)
- Dois tipos de plano: pré-pago e pós-pago
- Dois níveis de prioridade: normal (R$0,25) e urgente (R$0,50)
- Backoffice para gestão de créditos e limites
